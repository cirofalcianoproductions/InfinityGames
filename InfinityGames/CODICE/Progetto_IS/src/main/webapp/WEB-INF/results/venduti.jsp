...
<jsp:include page="banner.jsp">
    <jsp:param name="pageTitle" value="Venduti"/>
</jsp:include>
<div class="contain" ondblclick="chiudi(this)">
    <div class="contain_all">

        <p> IN QUESTA SEZIONE PUOI TROVARE I PRODOTTI PIU VENDUTI</p>
        <c:choose>
            <c:when test="${venduti.size() > 0}">
                <!-- MENU # 1 -->
                <div id="menu-main">
                    <div class="tab-bar2">
                        <div class="ordina2">
                                ...
                                <c:forEach items="${ord.values()}" var="o">
                                    <c:choose>
                                        ...
                                        <c:when test="${o == 'PREZZO_ASC'}">
                                            <c:set var="desc" value="piu venduti" />
                                        </c:when>
                                        <c:when test="${o == 'PREZZO_DESC'}">
                                            <c:set var="desc" value="meno venduti" />
                                        </c:when>
                                    </c:choose>
                                    <c:choose>
                                        <c:when test="${o == ord}">
